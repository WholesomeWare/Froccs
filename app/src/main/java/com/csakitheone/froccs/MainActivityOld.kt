        ...
        currentIngredients.map {
            val v = Chip(this).apply {
                ...
                setOnCloseIconClickListener { _ ->
                    MaterialAlertDialogBuilder(this@MainActivityOld)
                        .setTitle(it.name)
                        .setMessage("Biztos törlöd ezt az alapanyagot?")
                        .setPositiveButton("Igen") { _: DialogInterface, _: Int ->
                            Data.removeIngredient(this@MainActivityOld, it.name)
                            loadIngredients()
                        }
                ...
                IconButton(
                    onClick = {
                        MaterialAlertDialogBuilder(this@MainActivityOld)
                            ...
                            .setPositiveButton("Igen") { _: DialogInterface, _: Int ->
                                Data.removeRecipe(this@MainActivityOld, recipe)
                                loadRecipes()
                            }
                            .setNegativeButton("Nem") { _: DialogInterface, _: Int -> }
                            .create().show()
    ...
    fun btnNewIngredientClick(view: View) {
        ...
        MaterialAlertDialogBuilder(this)
            ...
            .setPositiveButton("Hozzáadás") { _: DialogInterface, _: Int ->
                ...
                Data.addIngredient(this, editIngredientName.text.toString())
                loadIngredients()
            }
            .create().show()
    }
